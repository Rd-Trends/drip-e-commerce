...
const productSchema = z.object({
  ...
  priceInNGN: z
    .number()
    .nullable()
    .describe('Price in Nigerian Naira as a plain number. null if not mentioned.'),
  ...
  images: z
    ...
    .describe('Images with IDs and alt text. Only include images actually present in the message.'),
...
EXAMPLE 1 — Shirt, single color:
  ...
  → productType: "shirt"
  → selectedVariants: [{ variantType: Size, existingOptions: [XS, S, M, L, XL, XXL from DB] }]
