...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_shipping_config_states_state" AS ENUM('abia', 'adamawa', 'akwa-ibom', 'anambra', 'bauchi', 'bayelsa', 'benue', 'borno', 'cross-river', 'delta', 'ebonyi', 'edo', 'ekiti', 'enugu', 'fct', 'gombe', 'imo', 'jigawa', 'kaduna', 'kano', 'katsina', 'kebbi', 'kogi', 'kwara', 'lagos', 'nasarawa', 'niger', 'ogun', 'ondo', 'osun', 'oyo', 'plateau', 'rivers', 'sokoto', 'taraba', 'yobe', 'zamfara');
  CREATE TYPE "public"."enum_banner_variant" AS ENUM('info', 'success', 'warning', 'promo');
  ...
  CREATE TABLE "coupons" (
  	...
  	"usage_limit" numeric,
  	"max_uses_per_user" numeric DEFAULT 1,
  ...
  CREATE TABLE "shipping_config_states" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"state" "enum_shipping_config_states_state" NOT NULL,
  	"fee" numeric,
  ...
  CREATE TABLE "shipping_config" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"default_fee" numeric DEFAULT 150000 NOT NULL,
  	"free_shipping_threshold" numeric,
  	"tax_rate" numeric DEFAULT 7.5 NOT NULL,
  	"updated_at" timestamp(3) with time zone,
  	"created_at" timestamp(3) with time zone
  );
  ...
  CREATE TABLE "banner" (
  	...
  	"text" varchar,
  	"variant" "enum_banner_variant" DEFAULT 'info',
  ...
  ALTER TABLE "shipping_config_states" ADD CONSTRAINT "shipping_config_states_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."shipping_config"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "shipping_config_states_order_idx" ON "shipping_config_states" USING btree ("_order");
  CREATE INDEX "shipping_config_states_parent_id_idx" ON "shipping_config_states" USING btree ("_parent_id");`)
}
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "shipping_config_states" CASCADE;
  ...
  DROP TYPE "public"."enum_shipping_config_states_state";
  DROP TYPE "public"."enum_banner_variant";`)
}
