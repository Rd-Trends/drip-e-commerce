...
export interface Config {
  ...
  jobs: {
    tasks: {
      sendAdminOrderNotification: AdminOrderNotificationTask;
      inline: {
        input: unknown;
        output: unknown;
      };
...
export interface PayloadJob {
  ...
  log?:
    | {
        executedAt: string;
        completedAt: string;
        taskSlug: 'inline' | 'sendAdminOrderNotification';
        taskID: string;
        input?:
          | {
              [k: string]: unknown;
    ...
    | null;
  taskSlug?: ('inline' | 'sendAdminOrderNotification') | null;
  queue?: string | null;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "AdminOrderNotificationTask".
 */
export interface AdminOrderNotificationTask {
  input: {
    orderId: number;
  };
  output?: unknown;
